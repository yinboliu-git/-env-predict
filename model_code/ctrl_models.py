...
def maxent_xlf(maxstep=100):
    return MaxEnt(maxstep=maxstep)


def ANN_xlf():
    return MLPClassifier(hidden_layer_sizes= (512,256,128), random_state=43)
...
xlf_dict = {'svm':svm_xlf(),'rf':rf_xlf(),'maxent':maxent_xlf(),'gbrt':gbrt_xlf()}
# xlf_dict = {'rf':rf_xlf, 'maxnet':maxent_xlf}
# xlf_dict = {'maxent':maxent_xlf(),'rf':rf_xlf}
